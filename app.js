...
// Get a single doc from a collection by docId
...
// ══════════════════════════════════════════
// DEFAULT DATA (seeded to Firestore on first load)
// ══════════════════════════════════════════
const DEFAULT_MEMBERS = [
  { id: '1',  name: 'Lord Devine',        role: '𝘿𝙀𝙑𝙀𝙇𝙊𝙋𝙀𝙍 / 𝙇𝙀𝘼𝘿𝙀𝙍',                      desc: 'The founder and supreme ruler of the Night Raiders. Every decision, every move, every war starts with him. The empire exists because of his vision.',                                                          ranked: true,  status: 'active' },
  { id: '2',  name: 'Lord Obito Uchiha',  role: '𝙍𝙄𝙂𝙃𝙏𝙃𝘼𝙉𝘿 𝙈𝘼𝙉 / 𝙃𝙀𝘼𝘿 𝙊𝙁 𝙃𝙄𝙅𝘼𝘾𝙆𝙀𝙍𝙎',         desc: 'The second in command. Leads the hijackers with precision — taking what needs to be taken without hesitation. Where Lord Devine commands, Lord Obito executes.',                                             ranked: true,  status: 'active' },
  { id: '3',  name: 'Lord Reaper',        role: '𝙇𝙀𝙁𝙏𝙃𝘼𝙉𝘿 𝙈𝘼𝙉 / 𝙃𝙀𝘼𝘿 𝙊𝙁 𝙎𝙋𝙔𝙎',              desc: 'Moves in silence. Controls the entire spy network and knows everything before it happens. By the time you think you have a secret, Reaper already knows.',                                                  ranked: true,  status: 'active' },
  { id: '4',  name: 'Lord Zephyr',        role: '𝙃𝙀𝘼𝘿 𝙊𝙁 𝘽𝙐𝙂𝙂𝙀𝙍𝙎',                          desc: 'No device is safe from him. Co-founder of the chaos — he was there from the very first raid. If your phone is acting up, you already know who sent him.',                                                    ranked: true,  status: 'active' },
  { id: '5',  name: 'Lady Deedee',        role: '𝙍𝘼𝙄𝘿𝙀𝙍𝙎 𝙂𝙊𝘿𝘿𝙀𝙎𝙎',                          desc: "Don't let the looks fool you. The most dangerous weapon in the clan wrapped in charm. She walks in and people underestimate her — that's the last mistake they make.",                                     ranked: true,  status: 'active' },
  { id: '6',  name: 'Lord Leviathan',     role: '𝙃𝙀𝘼𝘿 𝙊𝙁 𝙍𝙀𝘾𝙍𝙐𝙄𝙏𝙈𝙀𝙉𝙏',                      desc: 'The hunter of talent. Seeks out the strongest warriors and pulls them into the Night Raiders family. Every great member you see? Leviathan had a hand in finding them.',                                   ranked: true,  status: 'active' },
  { id: '7',  name: 'Lord Anonymous',     role: '𝘾𝙇𝘼𝙉 𝙀𝙓𝙀𝘾𝙐𝙏𝙄𝙊𝙉𝙀𝙍 / 𝙃𝙀𝘼𝘿 𝙊𝙁 𝙋𝙐𝙉𝙄𝙎𝙃𝙀𝙍𝙎',     desc: "When justice needs to be served, he's the one they call. No mercy, no hesitation, no trace. You won't see him coming — and that's exactly the point.",                                                  ranked: true,  status: 'active' },
  { id: '8',  name: 'Lord Subaru',        role: '𝙍𝘼𝙉𝙆𝙀𝘿 𝙈𝙀𝙈𝘽𝙀𝙍 / 𝘿𝙀𝙑𝙀𝙇𝙊𝙋𝙀𝙍',                desc: 'A ranked member and a developer. Builds the tools that keep the empire running from behind the scenes. The kind of mind that turns an idea into a weapon overnight.',                                        ranked: true,  status: 'active' },
  { id: '9',  name: 'Lord Probably',      role: '𝙍𝘼𝙉𝙆𝙀𝘿 𝙈𝙀𝙈𝘽𝙀𝙍 / 𝘿𝙀𝙑𝙀𝙇𝙊𝙋𝙀𝙍',                desc: "Don't be fooled by the name — there's nothing probably about it. A developer who codes with conviction and delivers without doubt. An asset the empire depends on.",                                       ranked: true,  status: 'active' },
  { id: '10', name: 'MR Dave Virus',      role: '𝙍𝘼𝙉𝙆𝙀𝘿 𝙈𝙀𝙈𝘽𝙀𝙍 / 𝙃𝘼𝘾𝙆𝙀𝙍',                   desc: 'The name says everything. A ranked hacker whose skills spread through systems like a virus — unstoppable, untraceable, and exactly what Night Raiders needed in its arsenal.',                                 ranked: true,  status: 'active' },
  { id: '11', name: 'Lord Slur',          role: '𝙍𝘼𝙉𝙆𝙀𝘿 𝙈𝙀𝙈𝘽𝙀𝙍',                            desc: 'Earned his rank the hard way. Lord Slur does not talk much — but when he acts, the results speak louder than words ever could. A quiet force inside the empire.',                                             ranked: true,  status: 'active' },
  { id: '12', name: 'Lord Deluxe',        role: '𝙍𝘼𝙉𝙆𝙀𝘿 𝙈𝙀𝙈𝘽𝙀𝙍',                            desc: 'Everything he does comes premium. Lord Deluxe carries the ranked badge with the kind of energy that elevates every room he steps into. Deluxe by name, elite by nature.',                                   ranked: true,  status: 'active' },
  { id: '13', name: 'Lord Monarch',       role: '𝙍𝘼𝙄𝘿𝙀𝙍',                                    desc: 'Built like a king. Lord Monarch moves through every operation with authority that cannot be taught — only earned. A raider who commands respect without demanding it.',                                        ranked: false, status: 'active' },
  { id: '14', name: 'Lady Annabelle',     role: '𝙍𝘼𝙄𝘿𝙀𝙍 / 𝘿𝙀𝙑𝙀𝙇𝙊𝙋𝙀𝙍',                        desc: 'A developer and a raider — two things most people cannot balance, and she does both without breaking a sweat. Lady Annabelle builds in silence and raids with precision.',                                    ranked: false, status: 'active' },
  { id: '15', name: 'Lord Ð@√!Ď',         role: '𝙍𝘼𝙄𝘿𝙀𝙍',                                    desc: 'The name alone tells you he operates differently. Unpredictable, adaptive, and the kind of raider that opponents never quite figure out until it is already too late.',                                       ranked: false, status: 'active' },
  { id: '16', name: 'Lord Sanemi',        role: '𝙍𝘼𝙄𝘿𝙀𝙍',                                    desc: 'Relentless. Lord Sanemi brings the kind of aggression to every raid that makes targets second-guess everything. He does not slow down and he does not stop.',                                                 ranked: false, status: 'active' },
  { id: '17', name: 'Lady Rosie',         role: '𝙍𝘼𝙄𝘿𝙀𝙍',                                    desc: "Pretty name, ruthless execution. Lady Rosie joined the Night Raiders and immediately made clear she wasn't here to blend in. She raids with grace and strikes without warning.",                            ranked: false, status: 'active' },
  { id: '18', name: 'Lord Korezy',        role: '𝙍𝘼𝙄𝘿𝙀𝙍',                                    desc: 'Cool under pressure and sharp in the field. Lord Korezy is the type of raider that stays calm when everything is loud — and that calm is what makes him dangerous.',                                         ranked: false, status: 'active' },
  { id: '19', name: 'Lady Gibby',         role: '𝙍𝘼𝙄𝘿𝙀𝙍',                                    desc: 'Underestimate her at your own risk. Lady Gibby brings energy and edge to every operation she is part of. A raider who shows up, shows out, and leaves her mark every time.',                                 ranked: false, status: 'active' },
  { id: '20', name: 'Lord Dangerous',     role: '𝙍𝘼𝙄𝘿𝙀𝙍',                                    desc: 'The name is not a warning — it is a fact. Lord Dangerous lives up to every letter of it. In any raid, in any operation, he is the variable that makes everything unpredictable.',                            ranked: false, status: 'active' },
  { id: '21', name: 'AnonRaiders',        role: '𝙍𝘼𝙄𝘿𝙀𝙍',                                    desc: 'No face. No trace. Just results. AnonRaiders operates in the shadows the way Night Raiders was built to — striking without identity and disappearing without evidence.',                                      ranked: false, status: 'active' },
];
...
// Seed Firestore with default data if collections are empty
async function seedIfEmpty() {
  // Stats
  const statsSnap = await fsGet('config', 'stats');
  if (!statsSnap) {
    await fsSet('config', 'stats', DEFAULT_DATA.stats);
  }
...
async function renderHomeAnn() {
  ...
  const anns = await fsGetAll('announcements');
  // Sort newest first by date field (fallback: creation order)
  anns.sort((a, b) => (b.createdAt?.seconds || 0) - (a.createdAt?.seconds || 0));
  const latest = anns.slice(0, 2);
  el.innerHTML = latest.length
    ? latest.map(a => annCardHTML(a)).join('')
...
async function renderMembers() {
  ...
  const members = await fsGetAll('members');
  // Ranked members first, then by id
  members.sort((a, b) => (b.ranked ? 1 : 0) - (a.ranked ? 1 : 0) || a.id.localeCompare(b.id));
...
async function addMember() {
  ...
  if (!name || !role) return;
  await fsAdd('members', { name, role, desc, ranked, status });
